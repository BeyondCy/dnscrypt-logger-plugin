 ...
 */
__declspec(dllexport) int dcplugin_init(DCPlugin * const dcplugin, int argc, char *argv[]);
 ...
 * @return 0 on success
 */
__declspec(dllexport) int dcplugin_destroy(DCPlugin * const dcplugin);
 ...
 */
__declspec(dllexport) const char *dcplugin_description(DCPlugin * const dcplugin);
 ...
 */
__declspec(dllexport) const char *dcplugin_long_description(DCPlugin * const dcplugin);
 ...
 */
__declspec(dllexport) DCPluginSyncFilterResult

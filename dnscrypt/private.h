...
#define DCPLUGIN_MAIN_PRIVATE(ID) \
    __declspec(dllexport) int dcplugin_interface_version_major = DCP_INTERFACE_VERSION_MAJOR; \
    __declspec(dllexport) int dcplugin_interface_version_minor = DCP_INTERFACE_VERSION_MINOR
